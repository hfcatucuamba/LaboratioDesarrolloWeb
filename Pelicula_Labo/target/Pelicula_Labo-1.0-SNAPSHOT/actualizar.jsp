    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="SvEditarPelicula" method="POST">
                ...
                Publicación:
                <br><input value="<%= pel.getPublicacion() %>" class="form-control" type="date" id="txtpubli" name="txtpubli"><br>
                Pais:
                <br><input value="<%= pel.getPais() %>" class="form-control" type="text" id="txtpais" name="txtpais"><br>
                Foto:
                <br><input value="<%= pel.getFoto() %>" class="form-control" type="file" id="txtfoto" name="txtfoto"><br><br>
